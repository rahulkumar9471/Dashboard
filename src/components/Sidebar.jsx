...
const Sidebar = ({ isSIdebar }) => {
  ...
  return (
    <div
      className={`bg-[#fff] max-w-[0px] sm:max-w-[0px] ${
            ...
            <ul className="flex flex-col gap-y-4">
              ...
              <li>
                <div
                  ...
                  className={`flex ${
                    isSIdebar ? "justify-start" : "justify-center"
                  } items-center gap-x-2 text-[16px] border-2 border-[#418160] p-2 text-[#418160] bg-[#fff] hover:bg-[#418160] hover:text-[#fff] rounded-[4px]`}
                >
                  <FaUser fontSize={20} />
                  ...
                  <ul className="">
                    <li className="mt-2">
                      <Link
                        ...
                        className={`flex ${
                          isSIdebar ? "justify-start" : "justify-center"
                        } items-center gap-x-2 text-[16px] block px-4 py-2 text-sm text-gray-800 hover:bg-gray-200 rounded-[4px]`}
                      >
